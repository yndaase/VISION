...
const SEED_MATERIALS = [
  { id: 's1', subject: 'core-maths',  title: 'Core Maths Study Guide 2026',      type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's2', subject: 'core-maths',  title: 'Core Maths Past Questions 2020-2025', type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's3', subject: 'english',     title: 'English Language Comprehension Pack', type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's4', subject: 'english',     title: 'Essay Writing & Summary Guide',     type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's5', subject: 'social',      title: 'Social Studies Complete Notes',     type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's6', subject: 'physics',     title: 'Physics Formula Sheet & Guide',     type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's7', subject: 'physics',     title: 'Physics Past Questions 2020-2025',  type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's8', subject: 'chemistry',   title: 'Chemistry Notes & Equations',       type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's9', subject: 'biology',     title: 'Biology Complete Revision Notes',   type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's10', subject: 'economics',  title: 'Economics Study Pack 2026',         type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
  { id: 's11', subject: 'cs',         title: 'Computer Science Study Guide',      type: 'PDF', size: '', url: '#', uploadedBy: 'admin', uploadedAt: '2026-04-01' },
];
...
function getMaterials() {
  try {
    const stored = JSON.parse(localStorage.getItem('vision_materials') || 'null');
...
function matTypeColor(type) {
  const map = { 'PDF': '#f87171', 'VIDEO': '#fb923c', 'DOC': '#60a5fa', 'SLIDE': '#a78bfa', 'LINK': '#4ade80' };
