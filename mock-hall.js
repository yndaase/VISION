...
async function initAIMock() {
  ...
  try {
    ...
    // Fetch all subjects in parallel (8 MCQs + 2 Theory per subject = 50 total)
    ...
    examState.mockConfig = {
      ...
      description: "A comprehensive 50-question multi-subject mission generated by AI. Cover all core WASSCE areas in one session.",
    ...
    alert("AI failed to build the full mission. Launching fallback mock.");
