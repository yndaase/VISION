...
const AI_MOCK_CONFIGS = {
  ...
  ai_mock_business:    { subject: "Business Management",         title: "Business Management AI Mock",           mcqCount: 25, theoryCount: 5, timeLimit: 150 },
  ai_mock_accounting:  { subject: "Financial Accounting",        title: "Financial Accounting AI Mock",          mcqCount: 25, theoryCount: 5, timeLimit: 150 },
  ai_mock_literature:  { subject: "Literature in English",       title: "Literature in English AI Mock",         mcqCount: 25, theoryCount: 5, timeLimit: 150 },
  ai_mock_french:      { subject: "French",                      title: "French AI Mock",                        mcqCount: 25, theoryCount: 5, timeLimit: 150 },
  ai_mock_history:     { subject: "History",                     title: "History AI Mock",                       mcqCount: 25, theoryCount: 5, timeLimit: 150 },
  ai_mock_government:  { subject: "Government",                  title: "Government AI Mock",                    mcqCount: 25, theoryCount: 5, timeLimit: 150 },
  ai_mock_crs:         { subject: "Christian Religious Studies", title: "Christian Religious Studies AI Mock",   mcqCount: 25, theoryCount: 5, timeLimit: 150 },
  ai_mock_twi:         { subject: "Twi",                         title: "Twi AI Mock",                           mcqCount: 25, theoryCount: 5, timeLimit: 150 },
  ...
  ai_mock_emath_focus: { subject: "Elective Mathematics",        title: "Elective Maths: Graphs, Gradients, Modulo & Differentiation", mcqCount: 25, theoryCount: 5, timeLimit: 150, focusTopics: "Graphs and graph interpretation, Gradient of a line (slope, equation of a line, parallel and perpendicular lines), Modulo arithmetic (mod operations, congruences, clock arithmetic), Differentiation (first principles, power rule, product rule, quotient rule, chain rule, applications of differentiation including maxima, minima, rate of change)" },
};
