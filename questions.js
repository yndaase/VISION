  ...
  science: [
    {
      id: 301,
      difficulty: "medium",
      topic: "Nature of Matter · Atomic Structure",
      question: "What is the atomic number of an element that has 6 protons and 8 neutrons?",
      options: {
        A: "14",
        B: "8",
        C: "6",
      ...
      correct: "C",
      workings: "Atomic Number = Number of Protons. The neutrons affect the Mass Number, not the Atomic Number.",
      protip: "Examiner's Secret: Protons identify the element; ignore neutrons and electrons when finding the primary atomic ID.",
    },
    {
      id: 302,
      difficulty: "easy",
      topic: "Ecology · Food Chains",
      question: "In a typical food chain, which organism always occupies the first trophic level?",
      options: {
        A: "Primary Consumer",
        B: "Producer",
        C: "Decomposer",
      ...
      correct: "B",
      workings: "Producers (plants) capture sunlight to create energy, forming the base of all trophic levels.",
      protip: "Examiner's Secret: Energy ALWAYS flows from producer upwards. Arrows represent energy flow.",
    },
    {
      id: 303,
      difficulty: "hard",
      topic: "Genetics · Mendelian Inheritance",
      question: "A heterozygous tall plant (Tt) is crossed with a homozygous short plant (tt). What is the phenotypic ratio of the offspring?",
      options: {
        A: "3 : 1",
        B: "1 : 1",
        C: "1 : 2 : 1",
      ...
      correct: "B",
      workings: "Cross: Tt × tt -> Offspring: Tt, Tt, tt, tt. This results in 50% Tall and 50% Short (Ratio 1:1).",
      protip: "Examiner's Secret: A test cross with a homozygous recessive always reveals the hidden allele of the parent.",
    },
    {
      id: 304,
      difficulty: "medium",
      topic: "Human Biology · Respiratory System",
      ...
      correct: "D",
      workings: "Arteries carry blood AWAY from the heart. Pulmonary = Lungs. Artery = Away.",
      protip: "Examiner's Secret: This is the ONLY artery in the body that carries deoxygenated blood. It's a classic trap.",
    },
    {
      id: 305,
      difficulty: "easy",
      topic: "Mechanisms · Simple Machines",
      question: "Which of the following machines is an example of a first-class lever?",
      options: {
        A: "Wheelbarrow",
        B: "Sugar Tongs",
        C: "Scissors",
      ...
      correct: "C",
      workings: "First-class lever: Fulcrum is between the Load and the Effort. Scissors have the pivot in the center.",
      protip: "Examiner's Secret: F-L-E rhyme: First Fulcrum, Second Load, Third Effort (in middle).",
    },
  ],
  physics: [
    {
      id: 401,
      difficulty: "easy",
      topic: "Energy · Renewable Sources",
      question: "Which of the following is considered a non-renewable source of energy?",
      options: {
        A: "Solar power",
        B: "Natural gas",
        C: "Hydroelectricity",
      ...
      correct: "B",
      workings: "Fossil fuels like natural gas cannot be replaced once consumed on a human timescale.",
      protip: "Examiner's Secret: Think 'Sustainability'—if it runs out, it's non-renewable.",
    },
    {
      id: 402,
      difficulty: "medium",
      topic: "Electricity · Circuit Calculations",
      question: "If a circuit has a voltage of 12V and a resistance of 4Ω, what is the current flowing through it?",
      options: {
        A: "48A",
        B: "16A",
        C: "3A",
      ...
      correct: "C",
      workings: "Ohm's Law: I = V / R = 12 / 4 = 3A.",
      protip: "Examiner's Secret: Always write I=V/R first. Common error is multiplying V×R (finding power/energy by mistake).",
    },
    {
      id: 403,
      difficulty: "hard",
      topic: "Mechanics · Projectile Motion",
      question: "At what angle should a projectile be launched to achieve the maximum horizontal range?",
      options: {
        A: "30 degrees",
        B: "45 degrees",
        C: "60 degrees",
      ...
      correct: "B",
      workings: "Optimal range is achieved at 45° due to the balance between vertical lift and horizontal speed.",
      protip: "Examiner's Secret: This assumes no air resistance—the theoretical maximum in all SHS physics problems.",
    },
    {
      id: 404,
      difficulty: "medium",
      topic: "Waves · Sound and Light",
      question: "Which wave characteristic determines the pitch of a sound note?",
      options: {
        A: "Amplitude",
        B: "Wavelength",
        C: "Frequency",
      ...
      correct: "C",
      workings: "Frequency measures how often a wave repeats. Higher frequency = Higher Pitch.",
      protip: "Examiner's Secret: Amplitude = Volume, Frequency = Pitch. Don't mix 'Loudness' with 'Highness'.",
    },
    {
      id: 405,
      difficulty: "easy",
      topic: "Heat · Thermodynamics",
      question: "What is the primary mode of heat transfer in a liquid like water?",
      options: {
        A: "Conduction",
        B: "Convection",
        C: "Radiation",
      ...
      correct: "B",
      workings: "Convection involves the movement of the fluid itself (hot rises, cool sinks).",
      protip: "Examiner's Secret: Solids = Conduction, Fluids (Liquids/Gases) = Convection, Vacuum/Gas = Radiation.",
    },
  ],
  social: [
    {
